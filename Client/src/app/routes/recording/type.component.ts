...
export class RecordingTypeComponent implements angular.AfterViewInit, angular.OnDestroy {
    ...
    ngAfterViewInit(): void {
        ...
        elem.dropdown({
            ...
            onChange: (s: string) => this.edit && (this.edit.containerType = parseInt(s, 10)),
        })

        setTimeout(() => {
            elem.dropdown('set exactly', `${this.edit?.containerType || recordingContainerType.Undefined}`)

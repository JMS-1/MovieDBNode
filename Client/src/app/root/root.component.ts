...
import { IMenuItem, SubMenuComponent } from '../semantic/menu/menu.component';
...
export class RootComponent implements OnDestroy {
  ...
  readonly newRoutes: IMenuItem[] = [
    {
      route: '/recordings/NEW/NEW',
      text: $localize`:@@menu.new.recording:Aufzeichnung erstellen`,
    },
    {
      route: '/series/NEW',
      text: $localize`:@@menu.new.series:Serie erstellen`,
    },
    {
      route: '/containers/NEW',
      text: $localize`:@@menu.new.container:Ablage erstellen`,
    },
    {
      route: '/languages/NEW',
      text: $localize`:@@menu.new.language:Sprache hinzufügen`,
    },
    {
      route: '/genres/NEW',
      text: $localize`:@@menu.new.genre:Kategorie hinzufügen`,
    },
  ];
  ...
  readonly themeRoutes: IMenuItem[] = [
    ...
    {
      route: 'alternate.1',
      text: $localize`:@@menu.themes.alt1:Alternative 1`,
    },
    {
      route: 'alternate.2',
      text: $localize`:@@menu.themes.alt2:Alternative 2`,
    },
  ];
  ...
  constructor(
    ...
    private readonly _themes: ThemeService,
  ) {

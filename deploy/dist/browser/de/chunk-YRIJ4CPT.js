import{a as S}from"./chunk-74EQGU3B.js";import{a as p,b as h,d as c,f as m,h as n,pa as _,qa as y}from"./chunk-WC7MP575.js";var a,O=new Uint8Array(16);function u(){if(!a&&(a=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||typeof msCrypto<"u"&&typeof msCrypto.getRandomValues=="function"&&msCrypto.getRandomValues.bind(msCrypto),!a))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return a(O)}var x=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;function b(t){return typeof t=="string"&&x.test(t)}var v=b;var i=[];for(l=0;l<256;++l)i.push((l+256).toString(16).substr(1));var l;function T(t){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,e=(i[t[r+0]]+i[t[r+1]]+i[t[r+2]]+i[t[r+3]]+"-"+i[t[r+4]]+i[t[r+5]]+"-"+i[t[r+6]]+i[t[r+7]]+"-"+i[t[r+8]]+i[t[r+9]]+"-"+i[t[r+10]]+i[t[r+11]]+i[t[r+12]]+i[t[r+13]]+i[t[r+14]]+i[t[r+15]]).toLowerCase();if(!v(e))throw TypeError("Stringified UUID is invalid");return e}var $=T;function q(t,r,e){t=t||{};var s=t.random||(t.rng||u)();if(s[6]=s[6]&15|64,s[8]=s[8]&63|128,r){e=e||0;for(var o=0;o<16;++o)r[e+o]=s[o];return r}return $(s)}var f=q;var w=`

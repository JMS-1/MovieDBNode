import{a as v}from"./chunk-B7J3NA4D.js";import{b as d}from"./chunk-R2SI53E2.js";import{Ea as x,Fa as $,a as m,b as _,d as y,i as S,l as a}from"./chunk-R44RXE5L.js";var l,q=new Uint8Array(16);function p(){if(!l&&(l=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||typeof msCrypto<"u"&&typeof msCrypto.getRandomValues=="function"&&msCrypto.getRandomValues.bind(msCrypto),!l))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return l(q)}var N=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;function w(t){return typeof t=="string"&&N.test(t)}var I=w;var i=[];for(f=0;f<256;++f)i.push((f+256).toString(16).substr(1));var f;function E(t){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,o=(i[t[r+0]]+i[t[r+1]]+i[t[r+2]]+i[t[r+3]]+"-"+i[t[r+4]]+i[t[r+5]]+"-"+i[t[r+6]]+i[t[r+7]]+"-"+i[t[r+8]]+i[t[r+9]]+"-"+i[t[r+10]]+i[t[r+11]]+i[t[r+12]]+i[t[r+13]]+i[t[r+14]]+i[t[r+15]]).toLowerCase();if(!I(o))throw TypeError("Stringified UUID is invalid");return o}var O=E;function P(t,r,o){t=t||{};var e=t.random||(t.rng||p)();if(e[6]=e[6]&15|64,e[8]=e[8]&63|128,r){o=o||0;for(var s=0;s<16;++s)r[o+s]=e[s];return r}return O(e)}var g=P;var D=`

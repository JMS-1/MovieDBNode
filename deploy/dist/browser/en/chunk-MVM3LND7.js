import{a as I}from"./chunk-EH6CR4F3.js";import{b as x}from"./chunk-F36R7FHD.js";import{Ia as S,Ja as $,a as h,b as m,d as _,i as y,l as a}from"./chunk-K4VRBPN2.js";var i=[];for(let r=0;r<256;++r)i.push((r+256).toString(16).slice(1));function v(r,t=0){return(i[r[t+0]]+i[r[t+1]]+i[r[t+2]]+i[r[t+3]]+"-"+i[r[t+4]]+i[r[t+5]]+"-"+i[r[t+6]]+i[r[t+7]]+"-"+i[r[t+8]]+i[r[t+9]]+"-"+i[r[t+10]]+i[r[t+11]]+i[r[t+12]]+i[r[t+13]]+i[r[t+14]]+i[r[t+15]]).toLowerCase()}var u,O=new Uint8Array(16);function f(){if(!u){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");u=crypto.getRandomValues.bind(crypto)}return u(O)}var b=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),g={randomUUID:b};function w(r,t,o){var n;r=r||{};let e=r.random??((n=r.rng)==null?void 0:n.call(r))??f();if(e.length<16)throw new Error("Random bytes length must be >= 16");if(e[6]=e[6]&15|64,e[8]=e[8]&63|128,t){if(o=o||0,o<0||o+16>t.length)throw new RangeError(`UUID byte range ${o}:${o+15} is out of buffer bounds`);for(let s=0;s<16;++s)t[o+s]=e[s];return t}return v(e)}function U(r,t,o){return g.randomUUID&&!t&&!r?g.randomUUID():w(r,t,o)}var l=U;var D=`

...
class SeriesHierarchicalCollection extends HierarchicalCollection<typeof Series> {
...
export const SeriesCollection = MongoConnection.createCollection(Series, SeriesHierarchicalCollection)
